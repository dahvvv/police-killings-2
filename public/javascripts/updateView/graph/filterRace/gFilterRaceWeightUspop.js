function updateGraphFilterRaceWeightUspop(){
  ...
  $(".graph-img").on("click", function(e){
    ...
    graphFilterRaceWeightUspopTipSample(elem);
  });
...
var styleGraphFilterRaceWeightUspop = {
  ...
  Tips: {
    ...
    onShow: function(tip, elem) {
      ...
      tip.innerHTML = "For every million " + race + " citizens of the United States,<br>" + elem.value + " have been killed by the police.<br />Click for a random example.";
    }
  },
  Events: {
    enable: true,
