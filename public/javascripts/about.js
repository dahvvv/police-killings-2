...
function rotateImages(length, i){
	$($(".about-img")[i % length]).animate({"border-radius":"6px"}, 1000, function(){
		console.log('1000');
...
// function rotateImages(length, oldPageNum){
// 	var i = 0;
// 	if (Math.abs(pageNum() - oldPageNum) === 1){
// 		$($(".about-img")[i % length]).fadeOut(500);
// 	}
...
var pages = {
	...
	3: "<p class='about-graf' id='graf1'>For this project, I used Fatal Encounters and US Police Shootings as my data set.</p><p class='about-graf' id='graf2'>I combined their respective information into one database.  My goal was to begin to analyze it, and to make it easier for others to do the same.</p><div class='pagenum' id='3'>3/20</div>",
	4: "<p class='about-graf' id='graf1'>Clicking on the buttons in the middle of the screen will change the style of information.</p><img class='about-img' src='http://i.imgur.com/f1GeAwv.png'><img class='about-img' style='display:none' src='http://i.imgur.com/juQSRiy.png'><img class='about-img' style='display:none' src='http://i.imgur.com/9fVyHhf.png'><div class='pagenum' id='4'>4/20</div>",
	...
	7: "<p class='about-graf' id='graf1'>Hovering over a section of a graph will show information on that section.</p><img class='about-img' src='http://i.imgur.com/3JCQiHx.png'><img class='about-img' style='display:none' src='http://i.imgur.com/X52pcht.png'><img class='about-img' style='display:none' src='http://i.imgur.com/Iloxxgn.png'><img class='about-img' style='display:none' src='http://i.imgur.com/2CwAu9N.png'><div class='pagenum' id='7'>7/20</div>",
};
