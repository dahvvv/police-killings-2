...
var pages = {
	...
	7: "<p class='about-graf' id='graf1'>Hovering over any section of a graph will show information about that section.</p><img class='about-img' src='http://i.imgur.com/3JCQiHx.png'><img class='about-img' style='display:none' src='http://i.imgur.com/X52pcht.png'><img class='about-img' style='display:none' src='http://i.imgur.com/Iloxxgn.png'><img class='about-img' style='display:none' src='http://i.imgur.com/2CwAu9N.png'><div class='pagenum' id='7'>7/11</div>",
	8: "<p class='about-graf' id='graf1'>Once you hover over a section of a graph, clicking on that section will open an article in a new tab about a person who fits the criteria for that section of the graph.  Clicking the same section again will open a new article about a different person.</p><p class='about-graf' id='graf2'>One of the best ways to use this site is to click on the same section of a graph many times.</p><div class='pagenum' id='8'>8/11</div>",
	9: "<p class='about-graf' id='graf1'>Clicking any dot on a map will open a popup, containing information and a source for that person.</p><img class='about-img' src='http://i.imgur.com/L23wbRC.png'><img class='about-img' style='display:none' src='http://i.imgur.com/vRCKOWr.png'><img class='about-img' style='display:none' src='http://i.imgur.com/VWCBp2k.png'><img class='about-img' style='display:none' src='http://i.imgur.com/h7xZBlD.png'><div class='pagenum' id='9'>9/11</div>",
