var programs = {
  heatmap: {
    ...
    age: {
      none: "<p class='program-text' style='top:-0.6em'>This heatmap is scaled to show similar total heat for any age range,<br>in order to emphasize changes in locations.</p>"
    },
    race: {
      none: "<p class='program-text' style='top:-0.6em'>This heatmap is scaled to present a constant population size,<br>in order to emphasize differences in location.</p>",
  ...
  marker: {
    ...
    age: {
      none: "<p class='program-text'>A point's size and brightness represent its distance from the standard deviation.<br>An unusual amount of very young or very old people have been killed in Texas and Arkansas.</p>"
    },
    race: {
      none: "<p class='program-text'>The racial distribution of people killed by police<br>in the United States.</p>",
      usPop: "<p class='program-text'>A map of police shootings by race,<br>scaled by US population.</p>",
      arrests: "<p class='program-text'>A map of police shooting by race,<br>scaled by rate of annual arrests.</p>"
    }
  },
  graph: {
    usPop: {
